    ...
    <>
      <style>{`
        ...
        .filter-btn {
          ...
          border: 1px solid #E2E2E0; cursor: pointer; letter-spacing: .01em;
          transition: all .2s;
          white-space: nowrap;
        }
        .filter-btn:hover {
        ...
        .metric-value {
          font-size: 1.5rem; font-weight: 700; color: #B8E0BA;
        }
        .metric-label {
          font-size: .75rem; color: #6B6B6B; font-family: 'DM Mono', monospace; letter-spacing: .05em; text-transform: uppercase;
        }
